class Calculator {
  constructor(previosOperandTextElemet, currentOperandTextElement) {
    this.previosOperandTextElement = previosOperandTextElemet;
  ...
  updateDisplay() {
    ...
    if (this.operation != null) {
      this.previosOperandTextElement.innerText = `${this.getDisplayNumber(
        this.previosOperand
      )} ${this.operation}`;
    } else {
